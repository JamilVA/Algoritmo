...
export default function GestionDocente() {
    ...
    const cargarDatos = async () => {
        try {
            const { data } = await axios.get('https://colegiosalgoritmo.edu.pe/api/docente', {});
            const { docentes } = data;
    ...
    const cargarGrupos = async () => {
        ...
        const { data } = await axios.get('https://colegiosalgoritmo.edu.pe/api/docente/cargarGrados', {});
        const { grupos } = data;
    ...
    const guardarDocente = () => {
        ...
        if (!docente.Codigo) {
            try {
                axios
                    .post('https://colegiosalgoritmo.edu.pe/api/docente', {
            ...
            try {
                axios
                    .put('https://colegiosalgoritmo.edu.pe/api/docente', {
    ...
    const asignarGrupo = async () => {
        await axios
            .put('https://colegiosalgoritmo.edu.pe/api/docente/asignarGrado', {
    ...
    const gradoBodyTemplate = (rowData: typeof docenteVacio) => {
        return (
            <div className="flex align-content-center">
                ...
                <div className="flex align-items-center justify-content-center">
                    <Button icon="pi pi-list" rounded text severity="secondary" onClick={() => openAsignarGrado(rowData)} tooltip={rowData.Grado?.Codigo != 0 ? 'Reasignar grado' : 'Asignar grado'} />
                </div>
            </div>
        );
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column header="Tutor de" sortable body={gradoBodyTemplate} headerStyle={{ minWidth: '6rem' }}></Column>
                    ...
                    <Dialog visible={docenteDialog} style={{ width: '600px' }} header="Datos del Docente" modal className="p-fluid" footer={docenteDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="form grid">
                            ...
                            <div className="field col">
                                ...
                                <Password
                                    value={docente?.Persona?.Usuario?.Password}
                                    onChange={(e) => {
