...
const GestionCursos = () => {
    ...
    const cargarCursos = async (CodigoGrado: number) => {
        ...
        try {
            const { data } = await axios.get('https://colegiosalgoritmo.edu.pe/api/curso', {
    ...
    const guardarCurso = () => {
        ...
        if (!curso.Codigo) {
            try {
                axios
                    .post('https://colegiosalgoritmo.edu.pe/api/curso', {
            ...
            try {
                axios
                    .put('https://colegiosalgoritmo.edu.pe/api/curso', {
