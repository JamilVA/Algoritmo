...
export default function BancoPreguntas() {
    ...
    const cargarTemas = async (CodigoCurso: any) => {
        try {
            const { data } = await axios.get('https://api.colegiosalgoritmo.edu.pe/api/pregunta/cargarTemas', {
                params: { CodigoCurso }
            });
    ...
    const cargarPreguntas = async (CodigoTema: number) => {
        try {
            const { data } = await axios.get('https://api.colegiosalgoritmo.edu.pe/api/pregunta/cargarPreguntas', {
                params: { CodigoTema }
            });
    ...
    const guardarPregunta = async () => {
        ...
        await axios
            .post('https://api.colegiosalgoritmo.edu.pe/api/pregunta/crearPregunta', {
    ...
    const modificarRuta = async (pregunta: any) => {
        await axios
            .put('https://api.colegiosalgoritmo.edu.pe/api/pregunta/imagenPregunta', {
                pregunta
            })
            .then((response) => {
    ...
    const handleUpload = async (event: FileUploadFilesEvent, rowData: any) => {
        ...
        await axios
            .post('https://api.colegiosalgoritmo.edu.pe/api/files/upload', formData)
            .then((response) => {
    ...
    const guardarTema = () => {
        ...
        if (_tema.Codigo == 0) {
            try {
                console.log('crear');
                axios
                    .post('https://api.colegiosalgoritmo.edu.pe/api/pregunta', {
            ...
            try {
                axios
                    .put('https://api.colegiosalgoritmo.edu.pe/api/pregunta', {
                        Codigo: _tema.Codigo,
                        Descripcion: _tema.Descripcion
                    })
                    .then((response) => {
