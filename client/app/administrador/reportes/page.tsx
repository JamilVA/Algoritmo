...
const Dashboard = () => {
    ...
    const cargarDatos = async () => {
        try {
            const { data } = await axios.get('https://back.colegiosalgoritmo.edu.pe/api/examen/infoReporte');
    ...
    const cargarReporte = async (CodigoGrado: number) => {
        ...
        try {
            const { data } = await axios.get('https://back.colegiosalgoritmo.edu.pe/api/examen/reporteGrado', {
    ...
    const cargarDataGraficos = async (CodigoGrado: number) => {
        try {
            const { data } = await axios.get('https://back.colegiosalgoritmo.edu.pe/api/examen/dataChart', {
                params: { CodigoGrado }
            });
