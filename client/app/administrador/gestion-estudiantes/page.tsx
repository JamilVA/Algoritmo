...
export default function GestionEstudiante() {
    ...
    const cargarDatos = async () => {
        try {
            const { data } = await axios.get('https://back.colegiosalgoritmo.edu.pe/api/estudiante', {});
    ...
    const cargarGrados = async () => {
        ...
        const { data } = await axios.get('https://back.colegiosalgoritmo.edu.pe/api/estudiante/cargarGrados', {});
        const { grados } = data;
    ...
    const guardarEstudiante = () => {
        ...
        if (!estudiante.Codigo) {
            axios
                .post('https://back.colegiosalgoritmo.edu.pe/api/estudiante', {
            ...
            try {
                axios
                    .put('https://back.colegiosalgoritmo.edu.pe/api/estudiante', {
